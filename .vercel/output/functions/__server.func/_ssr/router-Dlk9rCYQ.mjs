...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dlk9rCYQ.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: error.message || "Неожиданная ошибка. Обнови страницу."
			})
		]
	});
}
...
var SITE = {
	...
	headline: "для бега",
	description: "GPS-трекер, живая статистика, тренерские планы, архив забегов и до 100 достижений — в одном тёмном, быстром приложении.",
	launchAt: "2026-09-15T12:00:00+03:00",
	apkUrl: "/weirun.apk",
...
var FEATURES = [
	...
	},
	{
		id: "stats",
		title: "Аналитика",
		text: "Прогресс и форма за всё время, год, 30 и 7 дней — без лишнего шума.",
		icon: "chart"
	},
	{
		id: "achievements",
...
var SCREENS = [
	{
		src: "/screens/01.jpg",
		alt: "Главный экран WEIRUN со стартом и картой",
		caption: "Старт"
	},
	{
		src: "/screens/02.jpg",
		alt: "Экран записи забега с живой статистикой",
		caption: "Трекинг"
	},
	{
		src: "/screens/03.jpg",
		alt: "Подключение к тренеру и недельный план",
		caption: "Тренер"
	},
	{
		src: "/screens/04.jpg",
		alt: "Профиль атлета и основные данные",
		caption: "Профиль"
	},
	{
		src: "/screens/05.jpg",
		alt: "Архив треков и история забегов",
		caption: "Архив"
	},
	{
		src: "/screens/06.jpg",
		alt: "Аналитика прогресса и формы",
		caption: "Аналитика"
	},
	{
		src: "/screens/07.jpg",
		alt: "Достижения и уровни сложности",
		caption: "Достижения"
	}
];
var styles_default = "/assets/styles-LSyTGhJ9.css";
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{ title: `${APP_NAME} — трекер для бега` },
			{
				name: "description",
				content: "WEIRUN — современный GPS-трекер для бега. Живая статистика, тренерские планы, архив забегов и достижения. Скоро в RuStore и AppGallery."
			},
			{
				name: "theme-color",
				content: "#050d0a"
...
var $$splitComponentImporter = () => import("./routes-DygVHbvW.mjs");
...
//#endregion
export { SITE as a, SCREENS as i, FEATURES as n, NAV as r, router_exports as t };
